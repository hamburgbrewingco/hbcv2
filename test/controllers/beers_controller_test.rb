...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { alcohol: @beer.alcohol, description: @beer.description, name: @beer.name, type: @beer.type }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { alcohol: @beer.alcohol, description: @beer.description, name: @beer.name, type: @beer.type }
    assert_redirected_to beer_path(assigns(:beer))
  end
